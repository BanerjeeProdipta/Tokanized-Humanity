...
const HeroSection = () => {
  ...
  return (
    <div className="flex items-center justify-between w-full">
      ...
      >
        <img className="absolute top-0 right-0" src="https://tuk-cdn.s3.amazonaws.com/can-uploader/center_aligned_with_image-svg2.svg" alt="bg" />
        ...
        <div className="max-w-xl px-8 pl-12 space-y-12">
          <h1 className="text-5xl font-bold leading-tight text-white">Are you a minority group member?</h1>
          <p className="text-opacity/40">Minorities around the world can raise funds for leading a better life</p>
          <div className="flex items-center space-x-4">
            <Link to="/sign-up"
              className="px-4 py-1 text-sm text-white transition duration-150 ease-in-out bg-transparent border border-white rounded hover:text-primary lg:text-xl hover:border-primary focus:outline-none focus:ring-2 focus:ring-offset-2 ring-offset-primary focus:ring-white hover:bg-primary-800 sm:px-8 sm:py-3">Sign up</Link>
